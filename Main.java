...
public class Main
{
	...
	{
	    //the following code is the Sticks game
	    Scanner reader = new Scanner(System.in);
	    int sticks = (int)(Math.random()*10) + 21;
	    System.out.println("There are " + sticks + " sticks.");
	    System.out.println("Select 1 to go first, and 2 to go second.");
	    boolean turn; 
	    if(reader.nextInt() == 1) turn = true;
	    else turn = false;
	...
	public static int playerMove(int sticks, Scanner reader){
	    ...
	    if(take < 1) take = 1;
	    if(take > 3) take = 3;
	    else if(take > sticks) take = sticks;
